...
import CallObjectContext from './video_room/CallObjectContext';
import CopyLinkButton from './CopyLinkButton/CopyLinkButton';
import theme from './video_room/theme';
import {useOrientation, Orientation} from './video_room/useOrientation';
// @ts-ignore
import packageJson from '../../package.json';
import StartButton from './StartButton/StartButton';
import Button from './Button/Button';
import { logDailyEvent, robotID } from './video_room/utils';
...
const App = () => {
  ...
  const handleCreateRoom = async () => {
    ...
    try {
      ...
      setAppState(AppState.Idle);
      console.log('Navigating to room:', room.url);
      // Navigate to the room if necessary
    } catch (error) {
        ...
        <View
          ...
          {showCallPanel ? (
            ...
            <ScrollView
              ...
              <Image
                style={styles.logo}
                source={require('../../assets/calling/logo.png')}
              />
              <View style={styles.buttonContainer}>
                  ...
                  {!!roomUrlFieldValue && (
                    <TouchableWithoutFeedback
                      ...
                      <Image
                        ...
                        source={require('../../assets//calling/close.png')}
                      />
                    </TouchableWithoutFeedback>
                  )}
                </View>
                {roomCreateError && (
                  <View style={styles.textRow}>
                    <Image source={require('../../assets/calling/error.png')} />
