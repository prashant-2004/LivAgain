...
import { robotID } from '../video_room/utils';
...
export default function TrayButton({
  ...
  const getSource = () => {
    switch (type) {
      case 'camera':
        return muted
          ? require('../../../assets/calling/camera-off.png')
          : require('../../../assets/calling/camera.png');
      case 'mic':
        return muted
          ? require('../../../assets/calling/mic-off.png')
          : require('../../../assets/calling/mic.png');
      case 'leave':
        return require('../../../assets/calling/leave.png');
    }
  };
