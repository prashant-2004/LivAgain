...
import AudioCallRoom from './components/audio_session/AudioCallRoom';
...
<Stack.Screen
          name="VideoScreen"
          component={AudioCallRoom} // Add the new VideoScreen component
          options={() => ({
            title: 'Audio Call With Mentors',
            headerRight: () => (
              <TouchableOpacity
                style={{ marginRight: normalize(10) }}
                onPress={() => {
